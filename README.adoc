一个实验性的fork。相比于原版修改如下：

* `spring-boot` 版本升级为 `3.0`

* dao层从 `mybatis-plus` 修改为 `mybatis-mapper`

* parent从 `com.tairanchina.csp.dew:parent-starter` 修改为 `spring-boot-starter-parent`
...
ifndef::imagesdir[:imagesdir: modules/app-version-doc/src/main/asciidoc/images]
