...
public interface AdminService {
     ...
     * @return 列表
     */
    ServiceResult listApp(int page, int pageSize, Example<App> wrapper);
     ...
     * @return 列表
     */
    ServiceResult listAppWithBindInfo(int page, int pageSize, Example<App> wrapper, String userId);
     ...
     * @return 列表
     */
    ServiceResult listUser(int page, int pageSize, Example<User> wrapper);
